    ...
    public function index(){
        $cards = [
            ...
            [
                ...
                'type' => 'chart',
                'color' => '#6be6c1',
                'value' => $this->getChart(Opportunity::where('status', 'lost'),
                    'created_at')
            ],
            [
                ...
                'type' => 'chart',
                'color' => '#96dee8',
                'value' => $this->getChart(Opportunity::where('status', 'won'),
                    'created_at')
            ],
            [
                'title' => 'Paid Invoices',
                'type' => 'chart',
                'color' => '#96dee8',
                'value' => $this->getChart(Invoice::where('status', 'paid'),
                    'issue_date')
            ],
            [
                ...
                'type' => 'chart',
                'color' => '#96dee8',
                'value' => $this->getChart(Payment::where('status', 'deposited'),
                    'payment_date')
            ],
            [
